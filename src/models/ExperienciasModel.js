...
function experienciaPT(){
    ...
    empresas.push(new Experiencia("Infoideias","01/2017","07/2019","Delphi; MySQL; Oracle; Asp;  PHP; CSS; JQuery", "Manutenção de sistema desktop para escola; Manutenção em sistemas web( um sistema em Asp e outro em PHP); Suporte ao cliente; análise de requisitos; levantamento de necessidades; gerenciamento de equipe; gerenciamento de projetos") );
    empresas.push(new Experiencia("Exército Brasileiro","08/2019","Atualmente",
                                  "PHP; MySQL; Oracle; PostgreSQL;Moodle; Linux; Jenkins; Unity 3D; Ionic; JQuery; Javascript; Python; Redis; React", 
...
function experienciaEN(){
    ...
    empresas.push(new  Experiencia("Infoideias","01/2017","07/2019","Delphi; MySQL; Oracle; Asp;  PHP; CSS; JQuery; React", "Desktop system maintenance for school; Maintenance of web systems (one system in Asp and another in PHP); Customer support; requirements analysis; needs assessment; team management; project management") );
    empresas.push(new  Experiencia("Brazilian Army","08/2019","Current day",
                                  "PHP; MySQL; Oracle; PostgreSQL;Moodle; Linux; Jenkins; Unity 3D; Ionic; JQuery; Javascript; Python; Redis", 
